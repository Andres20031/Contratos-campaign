...
OUTPUT_DIR = os.path.join(ROOT_DIR, "app", "contratos_pdf", "contratoPaigCampaign")
...
def generarPaidPdf(contrato_data, influencer_data, customer_data, grupos_cliente):
    logger.info("👍Contrato paid-campaign")
    ...
    try:
        ...
        template = env.get_template("paid_template.html")
